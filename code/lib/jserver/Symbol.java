...
import lib.plotter.Point;
import lib.plotter.DataObject;
import lib.plotter.ImageObject;
import lib.plotter.LineStyle;
import lib.plotter.Plotter;
import lib.plotter.TextObject;
...
public class Symbol {
	...
	protected void draw(Plotter plotter) {
		...
		if (hintergrund != null) {
			...
			d.setCorners(new Point(pos.x - fullSize, pos.y + fullSize),
					new Point(pos.x + fullSize, pos.y - fullSize));
