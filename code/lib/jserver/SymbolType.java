...
public enum SymbolType {
	...
	static {
		...
		texts.put(BAR, "S�ulen");
		texts.put(BLOCK, "Block");
		texts.put(UP, "schr�ge Linien /");
		texts.put(DOWN, "schr�ge Linien \\");
		...
		texts.put(DICE_1, "W�rfel 1");
		texts.put(DICE_2, "W�rfel 2");
		texts.put(DICE_3, "W�rfel 3");
		texts.put(DICE_4, "W�rfel 4");
		texts.put(DICE_5, "W�rfel 5");
		texts.put(DICE_6, "W�rfel 6");
