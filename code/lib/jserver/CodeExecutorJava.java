...
public class CodeExecutorJava extends CodeExecutor {
	...
	public String compileAndExecute(String ignorefileName) {
		...
		File jarTest = new File("lib.jserver.jar");
		if (!jarTest.exists()) {
			messageField.append("lib.jserver.jar nicht gefunden\n");
		...
		String classPath = "." + File.pathSeparatorChar + "lib.jserver.jar";
