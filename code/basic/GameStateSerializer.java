...
public class GameStateSerializer {
    ...
    public void serializeGameState(GUI gui, String player, String color, Move move) throws FileSystemException {
        ...
        String subFolder    = playerName + color.toUpperCase() + delimiter + "col" + move.getS();
        ...
        if(currIndex == 0)
        {
            ...
            File folder = new File(MOD_KERAS_DIRECTORY + delimiter +IMG_DIRECTORY + delimiter + subFolder);
        ...
        saveBoardStateAsImage(gui, MOD_KERAS_DIRECTORY, IMG_DIRECTORY + delimiter + subFolder, fileName, IMG_FILE_EXTENSION);
    }
    ...
    public static void saveBoardStateAsImage(GUI gui, String directory, String subFolder, String filename, String fileExtension) throws FileSystemException {
        ...
        File folder = new File(directory + delimiter + subFolder);
        ...
        gui.getBoard().getGraphic().saveImageToFile(folder.getPath() + delimiter + filename + fileExtension, false);
    }
}
